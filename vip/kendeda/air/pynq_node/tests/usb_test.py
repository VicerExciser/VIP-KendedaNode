...
while True:
	try:
		...
		data = []
		data.append(co2_sensor.read_co2())
		data.append(opc_sensor.PM1())
		data.append(opc_sensor.PM25())
		data.append(opc_sensor.PM10())
		data.append("="*30)
		print("\nCO2   = {} ppm\nPM1   = {} #/cc\nPM2.5 = {} #/cc\nPM10  = {} #/cc\n{}\n".format(*data))
